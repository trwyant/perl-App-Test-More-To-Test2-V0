...
There are several pieces of functionality provided by L<Test::Warn|Test::Warn> that I have not found in Test2-land, either in C<Test2-Suite> itself or in add-on modules. At least, nothing in my L<Annotated Test2::Tools Index|https://trwyant.github.io/misc/all-perl-test2-tools.html> jumps out at me. These are:
