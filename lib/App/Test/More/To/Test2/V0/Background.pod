...
L<Test2::V0|Test2::V0> requires L<Term::Table|Term::Table>, which is being added to core as well. As of C<Term-Table> version 0.018 dated 2023-10-23 it also specifies Perl 5.8.1 or better in both metadata and F<Makefile.PL>.
